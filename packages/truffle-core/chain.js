...
try {
  ...
  throw new Error("Fatal: Error parsing arguments; please contact the tronbox developers for help.");
}
...
supervisor.use(new LoggerMixin(ipcLogger, 'tronbox.ipc.log'));
supervisor.use(new LoggerMixin(testrpcLogger, 'tronbox.testrpc.log'));
supervisor.start();
