...
See [the documentation](http://tronboxframework.com/docs/) for more details.

### Documentation

Please see the [Official tronbox Documentation](http://tronboxframework.com/docs/) for guides, tips, and examples.
...
[1]:https://github.com/trufflesuite/tronbox/blob/develop/CONTRIBUTING.md#development
